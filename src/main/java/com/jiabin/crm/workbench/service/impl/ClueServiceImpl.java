...
import com.jiabin.crm.workbench.dao.*;
import com.jiabin.crm.workbench.domain.*;
...
public class ClueServiceImpl implements ClueService {
    ...
    public boolean convert(String clueId, Tran t, String createBy) {
        ...
        /*
        ======经过第二步处理后，客户的信息（客户以公司存在）已经有了，将来在处理其他表的时候，
        如果需要使用客户的id,直接get即可
         */

        //3. 通过线索对象提取联系人信息，保存联系人，一个公司可以有多个联系人，故不用判断新增的联系人是否存在
        ...
        if (count2!=1){
         ...
         /*
        ======经过第三步处理后，联系人的信息已经有了，将来在处理其他表的时候，
        如果需要使用联系人的id,直接get即可
         */
