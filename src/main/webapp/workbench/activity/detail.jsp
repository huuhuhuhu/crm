	...
	$(function(){
            ...
            $.ajax({
                ...
                success:function (data) {
                    ...
                    if (data.success){
                        ...
                        /*
                            将onclick="deleteRemark中的原来是n.id,这样的话，新添加的备注无法显示
                            为什么
                         */
                        var html='';
        ...
        $("#updateRemarkBtn").click(function () {
            ...
            $.ajax({
                ...
                success:function (data) {
                    /*
                        data 中应该有修改成功或者失败的标记，一个市场活动备注的对象，来更新原来的备注
                     */
                    if (data.success){
                        //修改备注成功
                        alert("修改备注成功");
                        //更新div中相关的信息，需要更新的信息有 noteContent ,editTime,editBy
        ...
        $.ajax({
            ...
            success:function (data) {
                if (data.success){
                    ...
                    //showRemarkList() ;
                    //找到点击删除的备注div，将这个div,移除，也就是把备注删除了
                    $("#"+id).remove();
