...
/*
	对于1.数据量不是很大
		...
		如果同时满足以上两种情况，可以将数据保存在properties属性文件中
 ...
 */
			...
			$("#create-stage").change(function () {
				...
				/*目标：填写可能性
					1. 阶段
					2.阶段和可能性之间的对应关系pMap,是Java语言中的键值对关系
				...
				/*
					...
					因为今天的stage是一个可变的变量，那么我们就不能以传统的json.key的形式来取值
					我们要使用的取值方式为json[key]
	...
	<form  action="workbench/transaction/save.do" id="tranForm"  method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="0e831d24d1214c98bbc8102a15244d40" name="activityId">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="181c38f419ae4624bf64690f6d75f7ff" name="contactsId">
			</div>
		</div>
